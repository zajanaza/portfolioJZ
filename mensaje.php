  ...
  if(mail($adresa, $predmet, $text_zpravy)) {
    ...
    <section>
      <div class="container pt-5">
        <h2 class="fst-italic">Tu mensaje está enviado. Gracias.</h2>
        <div class="mt-3">
          <a href="index_es.html" class="mybutton2 btn">Volver</a>
        </div>
      </div>  
    </section>'
  ;} else {
    ...
    <section>
      <div class="container pt-5">
        <h2 class="fst-italic">No es posible enviar tu mensaje. Lo siento.</h2>
        <div class="mt-3">
          <a href="index_es.html" class="mybutton2 btn">Volver</a>
        </div>
      </div>  
